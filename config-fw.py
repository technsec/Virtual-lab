...
api_key = "LUFRPT1CU0dMRHIrOWFET0JUNzNaTmRoYmkwdjBkWWM9alUvUjBFTTNEQm93Vmx0OVhFRlNkOXdJNmVpYWk5Zmw4bEs3NjgwMkh5QT0="
...
def load_and_commit_config():
    ...
    with urllib.request.urlopen(config_file) as file:
